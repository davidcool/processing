...
public class GreatDisdyakisDodecahedron extends Polyhedron {
  ...
  final float C0 = 0.783611624891224327544304620751;   //3 * (2 * sqrt(2) - 1) / 7
  final float C1 = 0.961131723051122205602171216841;   //3 * (3 * sqrt(2) - 2) / 7
  ...
  private GreatDisdyakisDodecahedron() {   
    ...
    vert[  6] = new PVector(  C0, 0.0,  C0 );
    vert[  7] = new PVector(  C0, 0.0, -C0 );
    vert[  8] = new PVector( -C0, 0.0,  C0 );
    vert[  9] = new PVector( -C0, 0.0, -C0 );
    vert[ 10] = new PVector(  C0,  C0, 0.0 );
    vert[ 11] = new PVector(  C0, -C0, 0.0 );
    vert[ 12] = new PVector( -C0,  C0, 0.0 );
    vert[ 13] = new PVector( -C0, -C0, 0.0 );
    vert[ 14] = new PVector( 0.0,  C0,  C0 );
    vert[ 15] = new PVector( 0.0,  C0, -C0 );
    vert[ 16] = new PVector( 0.0, -C0,  C0 );
    vert[ 17] = new PVector( 0.0, -C0, -C0 );
