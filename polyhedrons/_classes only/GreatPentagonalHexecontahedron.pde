...
public class GreatPentagonalHexecontahedron extends Polyhedron {
  ...
  final float C0  = 0.0734018217014516670841263130528;    //square-root of a root of the polynomial:  4096*(x^6) - 16384*(x^5) + 24832*(x^4) - 17344*(x^3) + 4992*(x^2) - 212*x + 1
  final float C1  = 0.102690663988850052252480093759;     //square-root of a root of the polynomial:  4096*(x^6) - 18432*(x^5) + 16384*(x^4) - 8960*(x^3) + 8928*(x^2) - 188*x + 1
  final float C2  = 0.113690409611386992694315866713;     //square-root of a root of the polynomial:  4096*(x^6) - 13312*(x^5) + 9216*(x^4) - 9472*(x^3) + 1872*(x^2) - 100*x + 1
  final float C3  = 0.216381073600237044946795960472;     //square-root of a root of the polynomial:  4096*(x^6) + 3072*(x^5) - 16128*(x^4) - 17152*(x^3) + 2176*(x^2) - 84*x + 1
  final float C4  = 0.221457306337958486476607569170;     //square-root of a root of the polynomial:  4096*(x^6) - 19456*(x^5) + 40704*(x^4) - 44288*(x^3) + 21504*(x^2) - 3420*x + 121
  final float C5  = 0.239558806362705904548162003542;     //square-root of a root of the polynomial:  4096*(x^6) - 15360*(x^5) + 18944*(x^4) - 7168*(x^3) + 1024*(x^2) - 56*x + 1
  final float C6  = 0.257356768647573545542485428757;     //square-root of a root of the polynomial:  4096*(x^6) - 19456*(x^5) + 14592*(x^4) - 4736*(x^3) + 752*(x^2) - 48*x + 1
  final float C7  = 0.284923627010362671688163165899;     //square-root of a root of the polynomial:  4096*(x^6) - 12288*(x^5) - 768*(x^4) + 384*(x^3) + 272*(x^2) - 36*x + 1
  final float C8  = 0.335147715949345479170923435882;     //square-root of a root of the polynomial:  4096*(x^6) + 6144*(x^5) + 4352*(x^4) - 3456*(x^3) + 672*(x^2) - 48*x + 1
  final float C9  = 0.350378738996896029181911236597;     //square-root of a root of the polynomial:  3936256*(x^6) - 14764032*(x^5) + 2619648*(x^4) - 103040*(x^3) - 736*(x^2) + 32*x + 1
  final float C10 = 0.416411998906617305376802457828;     //square-root of a root of the polynomial:  4096*(x^6) - 11264*(x^5) + 9472*(x^4) - 2944*(x^3) + 432*(x^2) - 32*x + 1
  final float C11 = 0.423513753308827783006521119246;     //square-root of a root of the polynomial:  4096*(x^6) - 12288*(x^5) + 16896*(x^4) - 14528*(x^3) + 6112*(x^2) - 720*x + 1
  final float C12 = 0.468878573956484550146522281604;     //square-root of a root of the polynomial:  4096*(x^6) - 1024*(x^5) + 4096*(x^4) - 4672*(x^3) + 1392*(x^2) - 128*x + 1
  final float C13 = 0.501304700610599716634959126371;     //square-root of a root of the polynomial:  4096*(x^6) - 13312*(x^5) + 4608*(x^4) + 9920*(x^3) - 96*(x^2) - 1108*x + 121
  final float C14 = 0.566924708632306013012764112928;     //square-root of a root of the polynomial:  3936256*(x^6) - 7502848*(x^5) + 3239168*(x^4) - 452480*(x^3) + 17264*(x^2) + 208*x + 1
  final float C15 = 0.571569237945334602399002375363;     //square-root of a root of the polynomial:  4096*(x^6) - 27648*(x^5) + 72704*(x^4) - 92160*(x^3) + 54448*(x^2) - 11292*x + 361
  final float C16 = 0.574706522312051383719085439424;     //square-root of a root of the polynomial:  4096*(x^6) - 3072*(x^5) + 9728*(x^4) - 8960*(x^3) + 2944*(x^2) - 328*x + 1
  final float C17 = 0.644971059646786269483128688416;     //square-root of a root of the polynomial:  4096*(x^6) - 21504*(x^5) + 16384*(x^4) - 4672*(x^3) + 624*(x^2) - 40*x + 1
  final float C18 = 0.6737687675541908509192878865853;    //square-root of a root of the polynomial:  4096*(x^6) - 14336*(x^5) + 14592*(x^4) - 6016*(x^3) + 992*(x^2) - 48*x + 1
  final float C19 = 0.708437380319190454694684285146;     //square-root of a root of the polynomial:  4096*(x^6) - 4096*(x^5) + 3840*(x^4) - 14720*(x^3) + 17040*(x^2) - 6876*x + 841
  ...
  private GreatPentagonalHexecontahedron() {   
    ...
    vert[ 24] = new PVector(  0.0, -C14,   C9 );
    vert[ 25] = new PVector(  0.0, -C14,  -C9 );
    vert[ 26] = new PVector(  0.0,  C14,   C9 );
    vert[ 27] = new PVector(  0.0,  C14,  -C9 );
    vert[ 28] = new PVector( -C14,   C9,  0.0 );
    vert[ 29] = new PVector(  C14,   C9,  0.0 );
    vert[ 30] = new PVector( -C14,  -C9,  0.0 );
    vert[ 31] = new PVector(  C14,  -C9,  0.0 );
    vert[ 32] = new PVector(   C9,  0.0, -C14 );
    vert[ 33] = new PVector(   C9,  0.0,  C14 );
    vert[ 34] = new PVector(  -C9,  0.0, -C14 );
    vert[ 35] = new PVector(  -C9,  0.0,  C14 );
