/*
GreatTriambicIcosahedron class
...
public class GreatTriambicIcosahedron extends Polyhedron {
  ...
  final float C1 = 0.447213595499957939281834733746;  //sqrt(5) / 5
  final float C2 = 0.723606797749978969640917366873;  //(5 + sqrt(5)) / 10
  final float C3 = 1.61803398874989484820458683437;   //(1 + sqrt(5)) / 2
  final float C4 = 2.61803398874989484820458683437;   //(3 + sqrt(5)) / 2
  private PVector[] vert = new PVector[32]; // list of ve//rtices
  private int[][] faces =  new int[FACES][VERTICES];  // list of faces (joining vertices)
  
  private GreatTriambicIcosahedron() {   
    // set vertices
    vert[  0] = new PVector(  C2, 0.0,  C0 );
    vert[  1] = new PVector(  C2, 0.0, -C0 );
    vert[  2] = new PVector( -C2, 0.0,  C0 );
    vert[  3] = new PVector( -C2, 0.0, -C0 );
    vert[  4] = new PVector( 0.0,  C0,  C2 );
    vert[  5] = new PVector( 0.0,  C0, -C2 );
    vert[  6] = new PVector( 0.0, -C0,  C2 );
    vert[  7] = new PVector( 0.0, -C0, -C2 );
    vert[  8] = new PVector(  C0,  C2, 0.0 );
    vert[  9] = new PVector( -C0,  C2, 0.0 );
    vert[ 10] = new PVector(  C0, -C2, 0.0 );
    vert[ 11] = new PVector( -C0, -C2, 0.0 );
    vert[ 12] = new PVector( 0.0,  C4, -C3 );
    vert[ 13] = new PVector( 0.0,  C4,  C3 );
    vert[ 14] = new PVector( 0.0, -C4, -C3 );
    vert[ 15] = new PVector( 0.0, -C4,  C3 );
    vert[ 16] = new PVector(  C4, -C3, 0.0 );
    vert[ 17] = new PVector( -C4, -C3, 0.0 );
    vert[ 18] = new PVector(  C4,  C3, 0.0 );
    vert[ 19] = new PVector( -C4,  C3, 0.0 );
    vert[ 20] = new PVector( -C3, 0.0,  C4 );
    vert[ 21] = new PVector( -C3, 0.0, -C4 );
    vert[ 22] = new PVector(  C3, 0.0,  C4 );
    vert[ 23] = new PVector(  C3, 0.0, -C4 );
  ...
  } //end GreatTriambicIcosahedron()

  public String name() {
    return "Great Triambic Icosahedron";
  }
...
} //end class GreatTriambicIcosahedron
