/*
GreatTruncatedIcosidodecahedron class
...
public class GreatTruncatedIcosidodecahedron extends Polyhedron {
  
  // polyhedron
  final int FACES = 62;     // number of faces 
  final int VERTICES = 10;   // VERTICES per face
  final float C0 = 0.07294901687515772769311974845154;  //(7 - 3 * sqrt(5)) / 4
  final float C1 = 0.118033988749894848204586834366 ;   //(sqrt(5) - 2) / 2
  final float C2 = 0.190983005625052575897706582817 ;   //(3 - sqrt(5)) / 4
  final float C3 = 0.381966011250105151795413165634 ;   //(3 - sqrt(5)) / 2
  final float C4 = 0.427050983124842272306880251548 ;   //(3 * sqrt(5) - 5) / 4
  final float C5 = 0.618033988749894848204586834366 ;   //(sqrt(5) - 1) / 2
  final float C6 = 0.690983005625052575897706582817 ;   //(5 - sqrt(5)) / 4
  final float C7 = 0.736067977499789696409173668731 ;   //(2 * sqrt(5) - 3) / 2
  final float C8 = 0.881966011250105151795413165634 ;   //(4 - sqrt(5)) / 2
  final float C9 = 0.927050983124842272306880251548 ;   //3 * (sqrt(5) - 1) / 4
  private PVector[] vert = new PVector[120]; // list of ve//rtices
  private int[][] faces =  new int[FACES][VERTICES];  // list of faces (joining vertices)
  
  private GreatTruncatedIcosidodecahedron() {   
    // set vertices
    vert[  0] = new PVector(  0.5,  0.5,  -C7 );
    vert[  1] = new PVector(  0.5,  0.5,   C7 );
    vert[  2] = new PVector( -0.5,  0.5,  -C7 );
    vert[  3] = new PVector( -0.5,  0.5,   C7 );
    vert[  4] = new PVector(  0.5, -0.5,  -C7 );
    vert[  5] = new PVector(  0.5, -0.5,   C7 );
    vert[  6] = new PVector( -0.5, -0.5,  -C7 );
    vert[  7] = new PVector( -0.5, -0.5,   C7 );
    vert[  8] = new PVector(  0.5,  -C7,  0.5 );
    vert[  9] = new PVector(  0.5,  -C7, -0.5 );
    vert[ 10] = new PVector( -0.5,  -C7,  0.5 );
    vert[ 11] = new PVector( -0.5,  -C7, -0.5 );
    vert[ 12] = new PVector(  0.5,   C7,  0.5 );
    vert[ 13] = new PVector(  0.5,   C7, -0.5 );
    vert[ 14] = new PVector( -0.5,   C7,  0.5 );
    vert[ 15] = new PVector( -0.5,   C7, -0.5 );
    vert[ 16] = new PVector(  -C7,  0.5,  0.5 );
    vert[ 17] = new PVector(  -C7,  0.5, -0.5 );
    vert[ 18] = new PVector(   C7,  0.5,  0.5 );
    vert[ 19] = new PVector(   C7,  0.5, -0.5 );
    vert[ 20] = new PVector(  -C7, -0.5,  0.5 );
    vert[ 21] = new PVector(  -C7, -0.5, -0.5 );
    vert[ 22] = new PVector(   C7, -0.5,  0.5 );
    vert[ 23] = new PVector(   C7, -0.5, -0.5 );
    vert[ 24] = new PVector(   C2,  1.0,   C0 );
    vert[ 25] = new PVector(   C2,  1.0,  -C0 );
    vert[ 26] = new PVector(  -C2,  1.0,   C0 );
    vert[ 27] = new PVector(  -C2,  1.0,  -C0 );
    vert[ 28] = new PVector(   C2, -1.0,   C0 );
    vert[ 29] = new PVector(   C2, -1.0,  -C0 );
    vert[ 30] = new PVector(  -C2, -1.0,   C0 );
    vert[ 31] = new PVector(  -C2, -1.0,  -C0 );
    vert[ 32] = new PVector(  1.0,   C0,   C2 );
    vert[ 33] = new PVector(  1.0,   C0,  -C2 );
    vert[ 34] = new PVector( -1.0,   C0,   C2 );
    vert[ 35] = new PVector( -1.0,   C0,  -C2 );
    vert[ 36] = new PVector(  1.0,  -C0,   C2 );
    vert[ 37] = new PVector(  1.0,  -C0,  -C2 );
    vert[ 38] = new PVector( -1.0,  -C0,   C2 );
    vert[ 39] = new PVector( -1.0,  -C0,  -C2 );
    vert[ 40] = new PVector(   C0,   C2,  1.0 );
    vert[ 41] = new PVector(   C0,   C2, -1.0 );
    vert[ 42] = new PVector(  -C0,   C2,  1.0 );
    vert[ 43] = new PVector(  -C0,   C2, -1.0 );
    vert[ 44] = new PVector(   C0,  -C2,  1.0 );
    vert[ 45] = new PVector(   C0,  -C2, -1.0 );
    vert[ 46] = new PVector(  -C0,  -C2,  1.0 );
    vert[ 47] = new PVector(  -C0,  -C2, -1.0 );
    vert[ 48] = new PVector(  -C1,  0.5,   C8 );
    vert[ 49] = new PVector(  -C1,  0.5,  -C8 );
    vert[ 50] = new PVector(   C1,  0.5,   C8 );
    vert[ 51] = new PVector(   C1,  0.5,  -C8 );
    vert[ 52] = new PVector(  -C1, -0.5,   C8 );
    vert[ 53] = new PVector(  -C1, -0.5,  -C8 );
    vert[ 54] = new PVector(   C1, -0.5,   C8 );
    vert[ 55] = new PVector(   C1, -0.5,  -C8 );
    vert[ 56] = new PVector(  0.5,   C8,  -C1 );
    vert[ 57] = new PVector(  0.5,   C8,   C1 );
    vert[ 58] = new PVector( -0.5,   C8,  -C1 );
    vert[ 59] = new PVector( -0.5,   C8,   C1 );
    vert[ 60] = new PVector(  0.5,  -C8,  -C1 );
    vert[ 61] = new PVector(  0.5,  -C8,   C1 );
    vert[ 62] = new PVector( -0.5,  -C8,  -C1 );
    vert[ 63] = new PVector( -0.5,  -C8,   C1 );
    vert[ 64] = new PVector(   C8,  -C1,  0.5 );
    vert[ 65] = new PVector(   C8,  -C1, -0.5 );
    vert[ 66] = new PVector(  -C8,  -C1,  0.5 );
    vert[ 67] = new PVector(  -C8,  -C1, -0.5 );
    vert[ 68] = new PVector(   C8,   C1,  0.5 );
    vert[ 69] = new PVector(   C8,   C1, -0.5 );
    vert[ 70] = new PVector(  -C8,   C1,  0.5 );
    vert[ 71] = new PVector(  -C8,   C1, -0.5 );
    vert[ 72] = new PVector(  -C5,   C6,  -C4 );
    vert[ 73] = new PVector(  -C5,   C6,   C4 );
    vert[ 74] = new PVector(   C5,   C6,  -C4 );
    vert[ 75] = new PVector(   C5,   C6,   C4 );
    vert[ 76] = new PVector(  -C5,  -C6,  -C4 );
    vert[ 77] = new PVector(  -C5,  -C6,   C4 );
    vert[ 78] = new PVector(   C5,  -C6,  -C4 );
    vert[ 79] = new PVector(   C5,  -C6,   C4 );
    vert[ 80] = new PVector(   C6,  -C4,  -C5 );
    vert[ 81] = new PVector(   C6,  -C4,   C5 );
    vert[ 82] = new PVector(  -C6,  -C4,  -C5 );
    vert[ 83] = new PVector(  -C6,  -C4,   C5 );
    vert[ 84] = new PVector(   C6,   C4,  -C5 );
    vert[ 85] = new PVector(   C6,   C4,   C5 );
    vert[ 86] = new PVector(  -C6,   C4,  -C5 );
    vert[ 87] = new PVector(  -C6,   C4,   C5 );
    vert[ 88] = new PVector(  -C4,  -C5,   C6 );
    vert[ 89] = new PVector(  -C4,  -C5,  -C6 );
    vert[ 90] = new PVector(   C4,  -C5,   C6 );
    vert[ 91] = new PVector(   C4,  -C5,  -C6 );
    vert[ 92] = new PVector(  -C4,   C5,   C6 );
    vert[ 93] = new PVector(  -C4,   C5,  -C6 );
    vert[ 94] = new PVector(   C4,   C5,   C6 );
    vert[ 95] = new PVector(   C4,   C5,  -C6 );
    vert[ 96] = new PVector(  -C9,   C2,   C3 );
    vert[ 97] = new PVector(  -C9,   C2,  -C3 );
    vert[ 98] = new PVector(   C9,   C2,   C3 );
    vert[ 99] = new PVector(   C9,   C2,  -C3 );
    vert[100] = new PVector(  -C9,  -C2,   C3 );
    vert[101] = new PVector(  -C9,  -C2,  -C3 );
    vert[102] = new PVector(   C9,  -C2,   C3 );
    vert[103] = new PVector(   C9,  -C2,  -C3 );
    vert[104] = new PVector(   C2,   C3,  -C9 );
    vert[105] = new PVector(   C2,   C3,   C9 );
    vert[106] = new PVector(  -C2,   C3,  -C9 );
    vert[107] = new PVector(  -C2,   C3,   C9 );
    vert[108] = new PVector(   C2,  -C3,  -C9 );
    vert[109] = new PVector(   C2,  -C3,   C9 );
    vert[110] = new PVector(  -C2,  -C3,  -C9 );
    vert[111] = new PVector(  -C2,  -C3,   C9 );
    vert[112] = new PVector(   C3,  -C9,   C2 );
    vert[113] = new PVector(   C3,  -C9,  -C2 );
    vert[114] = new PVector(  -C3,  -C9,   C2 );
    vert[115] = new PVector(  -C3,  -C9,  -C2 );
    vert[116] = new PVector(   C3,   C9,   C2 );
    vert[117] = new PVector(   C3,   C9,  -C2 );
    vert[118] = new PVector(  -C3,   C9,   C2 );
    vert[119] = new PVector(  -C3,   C9,  -C2 );
    // set faces
  ...
  } //end GreatTruncatedIcosidodecahedron()

  public String name() {
    return "Great Truncated Icosidodecahedron";
  }
...
} //end class GreatTruncatedIcosidodecahedron
