...
public class MedialInvertedPentagonalHexecontahedron extends Polyhedron {
  ...
  final float C0  = 0.0194022103980084253546867792920;    //square-root of a root of the polynomial: 1048576*(x^8) - 2228224*(x^7) + 1380352*(x^6) + 189440*(x^5) - 355584*(x^4) + 26880*(x^3) + 20112*(x^2) - 2664*x + 1
  final float C1  = 0.0696395523817213604419851293951;    //square-root of a root of the polynomial: 65536*(x^8) - 163840*(x^7) + 196608*(x^6) - 138240*(x^5) + 60928*(x^4) - 17280*(x^3) + 2928*(x^2) - 220*x + 1
  final float C2  = 0.101032988262575617797477277823;     //square-root of a root of the polynomial: 1048576*(x^8) - 65536*(x^7) + 1576960*(x^6) - 47104*(x^5) + 547584*(x^4) - 106944*(x^3) + 6720*(x^2) - 156*x + 1
  final float C3  = 0.132081373112962278057743733979;     //square-root of a root of the polynomial: 1024*(x^4) + 832*(x^3) + 368*(x^2) - 64*x + 1
  final float C4  = 0.1440725985958081100585491031151;    //square-root of a root of the polynomial: 1048576*(x^8) - 65536*(x^7) - 847872*(x^6) - 262144*(x^5) + 388608*(x^4) - 66688*(x^3) + 6992*(x^2) - 168*x + 1
  final float C5  = 0.282000788731638777713749470244;     //square-root of a root of the polynomial: 1048576*(x^8) - 1638400*(x^7) + 643072*(x^6) - 627712*(x^5) + 1304064*(x^4) - 982272*(x^3) + 310464*(x^2) - 40248*x + 1681
  final float C6  = 0.301402999129647203068436249536;     //square-root of a root of the polynomial: 1048576*(x^8) - 65536*(x^7) + 1576960*(x^6) - 47104*(x^5) + 547584*(x^4) - 106944*(x^3) + 6720*(x^2) - 156*x + 1
  final float C7  = 0.372942812188055051898209029977;     //square-root of a root of the polynomial: 1048576*(x^8) - 104988672*(x^7) + 215617536*(x^6) - 97037312*(x^5) + 12262144*(x^4) - 362752*(x^3) - 1584*(x^2) + 88*x + 1
  final float C8  = 0.414082161844601055771493204223;     //square-root of a root of the polynomial: 1048576*(x^8) - 1638400*(x^7) + 643072*(x^6) - 627712*(x^5) + 1304064*(x^4) - 982272*(x^3) + 310464*(x^2) - 40248*x + 1681
  final float C9  = 0.445475597725455313126985352651;     //square-root of a root of the polynomial: 1048576*(x^8) - 3014656*(x^7) + 3444736*(x^6) - 2287616*(x^5) + 1100544*(x^4) - 455104*(x^3) + 131008*(x^2) - 18860*x + 961
  final float C10 = 0.515115150107176673568970482046;     //square-root of a root of the polynomial: 1048576*(x^8) - 2228224*(x^7) + 1380352*(x^6) + 189440*(x^5) - 355584*(x^4) + 26880*(x^3) + 20112*(x^2) - 2664*x + 1
  final float C11 = 0.557319849284645509736586878254;     //square-root of a root of the polynomial: 16*(x^4) + (x^3) - 9*(x^2) - x + 1
  final float C12 = 0.600359459617878001997658703546;     //square-root of a root of the polynomial: 1048576*(x^8) - 3014656*(x^7) + 3444736*(x^6) - 2287616*(x^5) + 1100544*(x^4) - 455104*(x^3) + 131008*(x^2) - 18860*x + 961
  final float C13 = 0.603434145980241615121159406736;     //square-root of a root of the polynomial: 1048576*(x^8) - 41484288*(x^7) + 84627456*(x^6) - 58661888*(x^5) + 16132864*(x^4) - 1589248*(x^3) + 46096*(x^2) + 392*x + 1
  final float C14 = 0.619761670015886427352345482838;     //square-root of a root of the polynomial: 65536*(x^8) - 163840*(x^7) + 196608*(x^6) - 138240*(x^5) + 60928*(x^4) - 17280*(x^3) + 2928*(x^2) - 220*x + 1
  final float C15 = 0.689401222397607787794330612233;     //square-root of a root of the polynomial: 256*(x^4) - 512*(x^3) + 240*(x^2) - 28*x + 1
  final float C16 = 0.701392447880453619795135981369;     //square-root of a root of the polynomial: 1048576*(x^8) - 65536*(x^7) - 847872*(x^6) - 262144*(x^5) + 388608*(x^4) - 66688*(x^3) + 6992*(x^2) - 168*x + 1
  final float C17 = 6.11938410981012529494715820772;      //square-root of a root of the polynomial: 1048576*(x^8) - 41484288*(x^7) + 84627456*(x^6) - 58661888*(x^5) + 16132864*(x^4) - 1589248*(x^3) + 46096*(x^2) + 392*x + 1
  final float C18 = 9.90137147988880157189465128431;      //square-root of a root of the polynomial: 1048576*(x^8) - 104988672*(x^7) + 215617536*(x^6) - 97037312*(x^5) + 12262144*(x^4) - 362752*(x^3) - 1584*(x^2) + 88*x + 1
  private PVector[] vert = new PVector[84]; // list of ve//rtices
  private int[][] faces =  new int[FACES][VERTICES];  // list of faces (joining vertices)
  
  private MedialInvertedPentagonalHexecontahedron() {   
    // set vertices
    vert[  0] = new PVector(  0.0,  C13,  -C7 );
    vert[  1] = new PVector(  0.0,  C13,   C7 );
    vert[  2] = new PVector(  0.0, -C13,  -C7 );
    vert[  3] = new PVector(  0.0, -C13,   C7 );
    vert[  4] = new PVector(  C13,  -C7,  0.0 );
    vert[  5] = new PVector( -C13,  -C7,  0.0 );
    vert[  6] = new PVector(  C13,   C7,  0.0 );
    vert[  7] = new PVector( -C13,   C7,  0.0 );
    vert[  8] = new PVector(  -C7,  0.0,  C13 );
    vert[  9] = new PVector(  -C7,  0.0, -C13 );
    vert[ 10] = new PVector(   C7,  0.0,  C13 );
    vert[ 11] = new PVector(   C7,  0.0, -C13 );
    ...
    vert[ 36] = new PVector(  0.0,  C18, -C17 );
    vert[ 37] = new PVector(  0.0,  C18,  C17 );
    vert[ 38] = new PVector(  0.0, -C18, -C17 );
    vert[ 39] = new PVector(  0.0, -C18,  C17 );
    vert[ 40] = new PVector(  C18, -C17,  0.0 );
    vert[ 41] = new PVector( -C18, -C17,  0.0 );
    vert[ 42] = new PVector(  C18,  C17,  0.0 );
    vert[ 43] = new PVector( -C18,  C17,  0.0 );
    vert[ 44] = new PVector( -C17,  0.0,  C18 );
    vert[ 45] = new PVector( -C17,  0.0, -C18 );
    vert[ 46] = new PVector(  C17,  0.0,  C18 );
    vert[ 47] = new PVector(  C17,  0.0, -C18 );
