...
public class SmallRhombihexacron extends Polyhedron {
  ...
  } //end SmallRhombihexacron()

  public String name() {
    return "Small Rhombihexacron";
  }
