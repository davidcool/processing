...
public class TrigonalTrapezohedron extends Polyhedron {
  ...
  } //end TrigonalTrapezohedron()

  public String name() {
    return "Trigonal Trapezohedron (Cube)";
  }
...
} //end class TrigonalTrapezohedron
