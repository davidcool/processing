/*
GreatTruncatedCuboctahedron class
...
public class GreatTruncatedCuboctahedron extends Polyhedron {
  ...
  final float C1 = 0.914213562373095048801688724210;   //(2 * sqrt(2) - 1) / 2
  private PVector[] vert = new PVector[48]; // list of ve//rtices
  private int[][] faces =  new int[FACES][VERTICES];  // list of faces (joining vertices)
  
  private GreatTruncatedCuboctahedron() {   
    // set vertices
  ...
  } //end GreatTruncatedCuboctahedron()

  public String name() {
    return "Great Truncated Cuboctahedron";
  }
...
} //end class GreatTruncatedCuboctahedron
