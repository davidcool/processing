/*
GreatDeltoidalHexecontahedron class
...
public class GreatDeltoidalHexecontahedron extends Polyhedron {
  
  // polyhedron
  final int FACES = 60;     // number of faces 
  final int VERTICES = 4;   // VERTICES per face
  final float C0 = 0.221608554659176942378065317337;   //(25 - 9 * sqrt(5)) / 22
  final float C1 = 0.284700655416561514871253501032;   //(3 * sqrt(5) - 5) / 6
  final float C2 = 0.358570173636287162330608606811;   //(4 * sqrt(5) - 5) / 11
  final float C3 = 0.4606553370833683839318043885448;  //(5 - sqrt(5)) / 6
  final float C4 = 0.580178728295464104708673924149;   //(15 - sqrt(5)) / 22
  final float C5 = 0.690983005625052575897706582817;   //(5 - sqrt(5)) / 4
  final float C6 = 1.11803398874989484820458683437;    //sqrt(5) / 2
  ...
  private GreatDeltoidalHexecontahedron() {   
    // set vertices
    vert[  0] = new PVector( 0.0, 0.0, -C8 );
    vert[  1] = new PVector( 0.0, 0.0,  C8 );
    vert[  2] = new PVector( 0.0, -C8, 0.0 );
    vert[  3] = new PVector( 0.0,  C8, 0.0 );
    vert[  4] = new PVector( -C8, 0.0, 0.0 );
    vert[  5] = new PVector(  C8, 0.0, 0.0 );
    vert[  6] = new PVector(  C4, 0.0,  C0 );
    vert[  7] = new PVector(  C4, 0.0, -C0 );
    vert[  8] = new PVector( -C4, 0.0,  C0 );
    vert[  9] = new PVector( -C4, 0.0, -C0 );
    vert[ 10] = new PVector( 0.0,  C0,  C4 );
    vert[ 11] = new PVector( 0.0,  C0, -C4 );
    vert[ 12] = new PVector( 0.0, -C0,  C4 );
    vert[ 13] = new PVector( 0.0, -C0, -C4 );
    vert[ 14] = new PVector(  C0,  C4, 0.0 );
    vert[ 15] = new PVector( -C0,  C4, 0.0 );
    vert[ 16] = new PVector(  C0, -C4, 0.0 );
    vert[ 17] = new PVector( -C0, -C4, 0.0 );
    ...
    vert[ 30] = new PVector( -C6,  C7,  C5 );
    vert[ 31] = new PVector( -C6,  C7, -C5 );
    vert[ 32] = new PVector(  C6,  C7,  C5 );
    vert[ 33] = new PVector(  C6,  C7, -C5 );
    vert[ 34] = new PVector( -C6, -C7,  C5 );
    vert[ 35] = new PVector( -C6, -C7, -C5 );
    vert[ 36] = new PVector(  C6, -C7,  C5 );
    vert[ 37] = new PVector(  C6, -C7, -C5 );
    vert[ 38] = new PVector(  C7,  C5, -C6 );
    vert[ 39] = new PVector(  C7,  C5,  C6 );
    vert[ 40] = new PVector( -C7,  C5, -C6 );
    vert[ 41] = new PVector( -C7,  C5,  C6 );
    vert[ 42] = new PVector(  C7, -C5, -C6 );
    vert[ 43] = new PVector(  C7, -C5,  C6 );
    vert[ 44] = new PVector( -C7, -C5, -C6 );
    vert[ 45] = new PVector( -C7, -C5,  C6 );
    vert[ 46] = new PVector(  C5, -C6,  C7 );
    vert[ 47] = new PVector(  C5, -C6, -C7 );
    vert[ 48] = new PVector( -C5, -C6,  C7 );
    vert[ 49] = new PVector( -C5, -C6, -C7 );
    vert[ 50] = new PVector(  C5,  C6,  C7 );
    vert[ 51] = new PVector(  C5,  C6, -C7 );
    vert[ 52] = new PVector( -C5,  C6,  C7 );
    vert[ 53] = new PVector( -C5,  C6, -C7 );
    vert[ 54] = new PVector( -C2, -C2, -C2 );
    vert[ 55] = new PVector( -C2, -C2,  C2 );
    vert[ 56] = new PVector(  C2, -C2, -C2 );
    vert[ 57] = new PVector(  C2, -C2,  C2 );
    vert[ 58] = new PVector( -C2,  C2, -C2 );
    vert[ 59] = new PVector( -C2,  C2,  C2 );
    vert[ 60] = new PVector(  C2,  C2, -C2 );
    vert[ 61] = new PVector(  C2,  C2,  C2 );
      // set faces
  ...
  } //end GreatDeltoidalHexecontahedron()

  public String name() {
    return "Great Deltoidal Hexecontahedron";
  }
...
} //end class GreatDeltoidalHexecontahedron
