...
public class GreatInvertedSnubIcosidodecahedron extends Polyhedron {
  ...
  final float C0  = 0.0458322048361746757966472099854;  //square-root of a root of the polynomial: 4096*(x^6) - 18432*(x^5) + 29184*(x^4) - 20160*(x^3) + 5728*(x^2) - 488*x + 1
  ...
  final float C2  = 0.113317456590685126375650604467;   //square-root of a root of the polynomial: 4096*(x^6) - 9728*(x^4) - 3072*(x^3) + 4256*(x^2) - 132*x + 1
  final float C3  = 0.187475521794963058008011505776;   //square-root of a root of the polynomial: 4096*(x^6) + 6144*(x^5) + 4352*(x^4) - 3456*(x^3) + 672*(x^2) - 48*x + 1
  final float C4  = 0.206012745126162897462898732354;   //square-root of a root of the polynomial: 4096*(x^6) - 19456*(x^5) + 14592*(x^4) - 4736*(x^3) + 752*(x^2) - 48*x + 1
  final float C5  = 0.229183701118593991387526824407;   //square-root of a root of the polynomial: 4096*(x^6) - 5120*(x^5) + 9472*(x^4) - 5888*(x^3) + 1216*(x^2) - 68*x + 1
  final float C6  = 0.257509561486697247223240515731;   //square-root of a root of the polynomial: 4096*(x^6) - 13312*(x^5) + 9216*(x^4) - 9472*(x^3) + 1872*(x^2) - 100*x + 1
  final float C7  = 0.280170810330440829095259633663;   //square-root of a root of the polynomial:  4096*(x^6) - 17408*(x^5) + 28672*(x^4) - 21696*(x^3) + 6672*(x^2) - 416*x + 1
  final float C8  = 0.379167828565975488150770490117;   //square-root of a root of the polynomial: 4096*(x^6) - 15360*(x^5) + 18944*(x^4) - 7168*(x^3) + 1024*(x^2) - 56*x + 1
  final float C9  = 0.407493688934078743986484181441;   //square-root of a root of the polynomial: 4096*(x^6) - 21504*(x^5) + 16384*(x^4) - 4672*(x^3) + 624*(x^2) - 40*x + 1
  final float C10 = 0.4635223066128601446861392480851;  //square-root of a root of the polynomial: 4096*(x^6) - 12288*(x^5) + 15872*(x^4) - 6016*(x^3) + 912*(x^2) - 56*x + 1
  final float C11 = 0.509354511449034820482786458071;   //square-root of a root of the polynomial: 4096*(x^6) - 12288*(x^5) - 768*(x^4) + 384*(x^3) + 272*(x^2) - 36*x + 1
  final float C12 = 0.520811145524763870362134785908;   //square-root of a root of the polynomial: 4096*(x^6) + 3072*(x^5) - 3584*(x^4) - 2048*(x^3) + 1312*(x^2) - 160*x + 1
  final float C13 = 0.566643350360938546158781995893;   //square-root of a root of the polynomial: 4096*(x^6) - 3072*(x^5) + 9728*(x^4) - 8960*(x^3) + 2944*(x^2) - 328*x + 1
  final float C14 = 0.636677390052672735374011005848;   //square-root of a root of the polynomial: 4096*(x^6) - 8192*(x^5) + 1792*(x^4) - 7488*(x^3) + 3456*(x^2) - 116*x + 1
