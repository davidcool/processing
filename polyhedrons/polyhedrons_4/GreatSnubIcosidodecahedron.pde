...
public class GreatSnubIcosidodecahedron extends Polyhedron {
  ...
  final float C0  = 0.0812642829572718262058790219454;  //square-root of a root of the polynomial: 4096*(x^6) + 3072*(x^5) - 3584*(x^4) - 2048*(x^3) + 1312*(x^2) - 160*x + 1
  final float C1  = 0.113690409611386992694315866713;   //square-root of a root of the polynomial: 4096*(x^6) - 13312*(x^5) + 9216*(x^4) - 9472*(x^3) + 1872*(x^2) - 100*x + 1
  final float C2  = 0.125868396751318911853846136829;   //square-root of a root of the polynomial: 4096*(x^6) - 8192*(x^5) + 1792*(x^4) - 7488*(x^3) + 3456*(x^2) - 116*x + 1
  final float C3  = 0.239558806362705904548162003542;   //square-root of a root of the polynomial: 4096*(x^6) - 15360*(x^5) + 18944*(x^4) - 7168*(x^3) + 1024*(x^2) - 56*x + 1
  final float C4  = 0.257356768647573545542485428757;   //square-root of a root of the polynomial: 4096*(x^6) - 19456*(x^5) + 14592*(x^4) - 4736*(x^3) + 752*(x^2) - 48*x + 1
  final float C5  = 0.284923627010362671688163165899;   //square-root of a root of the polynomial: 4096*(x^6) - 12288*(x^5) - 768*(x^4) + 384*(x^3) + 272*(x^2) - 36*x + 1
  final float C6  = 0.335147715949345479170923435882;   //square-root of a root of the polynomial: 4096*(x^6) + 6144*(x^5) + 4352*(x^4) - 3456*(x^3) + 672*(x^2) - 48*x + 1
  final float C7  = 0.371047178258960538236801295470;   //square-root of a root of the polynomial: 4096*(x^6) - 12288*(x^5) + 15872*(x^4) - 6016*(x^3) + 912*(x^2) - 56*x + 1
  final float C8  = 0.468878573956484550146522281604;   //square-root of a root of the polynomial: 4096*(x^6) - 1024*(x^5) + 4096*(x^4) - 4672*(x^3) + 1392*(x^2) - 128*x + 1
  final float C9  = 0.519102662895467357629282551587;   //square-root of a root of the polynomial: 4096*(x^6) - 5120*(x^5) + 9472*(x^4) - 5888*(x^3) + 1216*(x^2) - 68*x + 1
  final float C10 = 0.574706522312051383719085439424;   //square-root of a root of the polynomial: 4096*(x^6) - 3072*(x^5) + 9728*(x^4) - 8960*(x^3) + 2944*(x^2) - 328*x + 1
  final float C11 = 0.644971059646786269483128688416;   //square-root of a root of the polynomial: 4096*(x^6) - 21504*(x^5) + 16384*(x^4) - 4672*(x^3) + 624*(x^2) - 40*x + 1
  final float C12 = 0.655970805269323209924964461370;   //square-root of a root of the polynomial:  4096*(x^6) - 18432*(x^5) + 29184*(x^4) - 20160*(x^3) + 5728*(x^2) - 488*x + 1
  final float C13 = 0.726235342604058095689007710362;   //square-root of a root of the polynomial: 4096*(x^6) - 9728*(x^4) - 3072*(x^3) + 4256*(x^2) - 132*x + 1
  final float C14 = 0.804026289905830029317445717487;   //square-root of a root of the polynomial:  4096*(x^6) - 17408*(x^5) + 28672*(x^4) - 21696*(x^3) + 6672*(x^2) - 416*x + 1
