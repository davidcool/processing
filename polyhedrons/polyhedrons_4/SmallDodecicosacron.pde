...
public class SmallDodecicosacron extends Polyhedron {
  ...
  final float C4 = 3.927050983124842272306880251548;  //3 * (3 + sqrt(5)) / 4
  private PVector[] vert = new PVector[32]; // list of ve//rtices
  private int[][] faces =  new int[FACES][VERTICES];  // list of faces (joining vertices)
  
  private SmallDodecicosacron() {   
    // set vertices
    vert[  0] = new PVector(  C3, 0.0,  C4 );
    vert[  1] = new PVector(  C3, 0.0, -C4 );
    vert[  2] = new PVector( -C3, 0.0,  C4 );
    vert[  3] = new PVector( -C3, 0.0, -C4 );
    vert[  4] = new PVector(  C4,  C3, 0.0 );
    vert[  5] = new PVector(  C4, -C3, 0.0 );
    vert[  6] = new PVector( -C4,  C3, 0.0 );
    vert[  7] = new PVector( -C4, -C3, 0.0 );
    vert[  8] = new PVector( 0.0,  C4,  C3 );
    vert[  9] = new PVector( 0.0,  C4, -C3 );
    vert[ 10] = new PVector( 0.0, -C4,  C3 );
    vert[ 11] = new PVector( 0.0, -C4, -C3 );
  ...
  } //end SmallDodecicosacron()

  public String name() {
    return "Small Dodecicosacron";
  }
