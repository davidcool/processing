...
public class SmallDodecicosahedron extends Polyhedron {
  ...
  private SmallDodecicosahedron() {   
    // set vertices
    vert[  0] = new PVector(  0.5,   C0,   C3 );
    vert[  1] = new PVector(  0.5,   C0,  -C3 );
    vert[  2] = new PVector(  0.5,  -C0,   C3 );
    vert[  3] = new PVector(  0.5,  -C0,  -C3 );
    vert[  4] = new PVector( -0.5,   C0,   C3 );
    vert[  5] = new PVector( -0.5,   C0,  -C3 );
    vert[  6] = new PVector( -0.5,  -C0,   C3 );
    vert[  7] = new PVector( -0.5,  -C0,  -C3 );
    vert[  8] = new PVector(   C3,  0.5,   C0 );
    vert[  9] = new PVector(   C3,  0.5,  -C0 );
    vert[ 10] = new PVector(   C3, -0.5,   C0 );
    vert[ 11] = new PVector(   C3, -0.5,  -C0 );
    vert[ 12] = new PVector(  -C3,  0.5,   C0 );
    vert[ 13] = new PVector(  -C3,  0.5,  -C0 );
    vert[ 14] = new PVector(  -C3, -0.5,   C0 );
    vert[ 15] = new PVector(  -C3, -0.5,  -C0 );
    vert[ 16] = new PVector(   C0,   C3,  0.5 );
    vert[ 17] = new PVector(   C0,   C3, -0.5 );
    vert[ 18] = new PVector(   C0,  -C3,  0.5 );
    vert[ 19] = new PVector(   C0,  -C3, -0.5 );
    vert[ 20] = new PVector(  -C0,   C3,  0.5 );
    vert[ 21] = new PVector(  -C0,   C3, -0.5 );
    vert[ 22] = new PVector(  -C0,  -C3,  0.5 );
    vert[ 23] = new PVector(  -C0,  -C3, -0.5 );
    vert[ 24] = new PVector(  0.0,   C1,   C2 );
    vert[ 25] = new PVector(  0.0,   C1,  -C2 );
    vert[ 26] = new PVector(  0.0,  -C1,   C2 );
    vert[ 27] = new PVector(  0.0,  -C1,  -C2 );
    vert[ 28] = new PVector(   C2,  0.0,   C1 );
    vert[ 29] = new PVector(   C2,  0.0,  -C1 );
    vert[ 30] = new PVector(  -C2,  0.0,   C1 );
    vert[ 31] = new PVector(  -C2,  0.0,  -C1 );
    vert[ 32] = new PVector(   C1,   C2,  0.0 );
    vert[ 33] = new PVector(   C1,  -C2,  0.0 );
    vert[ 34] = new PVector(  -C1,   C2,  0.0 );
    vert[ 35] = new PVector(  -C1,  -C2,  0.0 );
    vert[ 36] = new PVector(  1.0,  0.5,   C2 );
    vert[ 37] = new PVector(  1.0,  0.5,  -C2 );
    vert[ 38] = new PVector(  1.0, -0.5,   C2 );
    vert[ 39] = new PVector(  1.0, -0.5,  -C2 );
    vert[ 40] = new PVector( -1.0,  0.5,   C2 );
    vert[ 41] = new PVector( -1.0,  0.5,  -C2 );
    vert[ 42] = new PVector( -1.0, -0.5,   C2 );
    vert[ 43] = new PVector( -1.0, -0.5,  -C2 );
    vert[ 44] = new PVector(   C2,  1.0,  0.5 );
    vert[ 45] = new PVector(   C2,  1.0, -0.5 );
    vert[ 46] = new PVector(   C2, -1.0,  0.5 );
    vert[ 47] = new PVector(   C2, -1.0, -0.5 );
    vert[ 48] = new PVector(  -C2,  1.0,  0.5 );
    vert[ 49] = new PVector(  -C2,  1.0, -0.5 );
    vert[ 50] = new PVector(  -C2, -1.0,  0.5 );
    vert[ 51] = new PVector(  -C2, -1.0, -0.5 );
    vert[ 52] = new PVector(  0.5,   C2,  1.0 );
    vert[ 53] = new PVector(  0.5,   C2, -1.0 );
    vert[ 54] = new PVector(  0.5,  -C2,  1.0 );
    vert[ 55] = new PVector(  0.5,  -C2, -1.0 );
    vert[ 56] = new PVector( -0.5,   C2,  1.0 );
    vert[ 57] = new PVector( -0.5,   C2, -1.0 );
    vert[ 58] = new PVector( -0.5,  -C2,  1.0 );
    vert[ 59] = new PVector( -0.5,  -C2, -1.0 );
    // set faces
