...
public class SmallRetrosnubIcosicosidodecahedron extends Polyhedron {
  ...
  final float C0 = 0.0666198004130689535045639687526;  //(3 - sqrt(3 + 2 * sqrt(5))) / 4
  final float C1 = 0.12436320521198362239314261406454; //(sqrt(3 + 2 * sqrt(5)) - sqrt(5)) / 4
  final float C2 = 0.232156306604063473669297042801;   //(3+sqrt(5)-sqrt(2*(3*sqrt(5)-1))) / 8
  final float C3 = 0.267843693395936526330702957199;   //(1-sqrt(5)+sqrt(2*(3*sqrt(5)-1))) / 8
  final float C4 = 0.309016994374947424102293417183;   //(sqrt(5) - 1) / 4
  final float C5 = 0.433380199586931046495436031247;   //(sqrt(3 + 2 * sqrt(5)) - 1) / 4
  final float C6 = 0.576860687770883950432996374382;   //(sqrt(5)-1+sqrt(2*(3*sqrt(5)-1))) / 8
  ...
  private SmallRetrosnubIcosicosidodecahedron() {   
    // set vertices
    vert[  0] = new PVector(  -C6,  0.0,   C0 );
    vert[  1] = new PVector(  -C6,  0.0,  -C0 );
    vert[  2] = new PVector(   C6,  0.0,   C0 );
    vert[  3] = new PVector(   C6,  0.0,  -C0 );
    vert[  4] = new PVector(   C0,  -C6,  0.0 );
    vert[  5] = new PVector(   C0,   C6,  0.0 );
    vert[  6] = new PVector(  -C0,  -C6,  0.0 );
    vert[  7] = new PVector(  -C0,   C6,  0.0 );
    vert[  8] = new PVector(  0.0,   C0,  -C6 );
    vert[  9] = new PVector(  0.0,   C0,   C6 );
    vert[ 10] = new PVector(  0.0,  -C0,  -C6 );
    vert[ 11] = new PVector(  0.0,  -C0,   C6 );
    vert[ 12] = new PVector(  -C3,  0.5,  -C1 );
    vert[ 13] = new PVector(  -C3,  0.5,   C1 );
    vert[ 14] = new PVector(  -C3, -0.5,  -C1 );
    vert[ 15] = new PVector(  -C3, -0.5,   C1 );
    vert[ 16] = new PVector(   C3,  0.5,  -C1 );
    vert[ 17] = new PVector(   C3,  0.5,   C1 );
    vert[ 18] = new PVector(   C3, -0.5,  -C1 );
    vert[ 19] = new PVector(   C3, -0.5,   C1 );
    vert[ 20] = new PVector(  -C1,  -C3,  0.5 );
    vert[ 21] = new PVector(  -C1,  -C3, -0.5 );
    vert[ 22] = new PVector(  -C1,   C3,  0.5 );
    vert[ 23] = new PVector(  -C1,   C3, -0.5 );
    vert[ 24] = new PVector(   C1,  -C3,  0.5 );
    vert[ 25] = new PVector(   C1,  -C3, -0.5 );
    vert[ 26] = new PVector(   C1,   C3,  0.5 );
    vert[ 27] = new PVector(   C1,   C3, -0.5 );
    vert[ 28] = new PVector(  0.5,  -C1,  -C3 );
    vert[ 29] = new PVector(  0.5,  -C1,   C3 );
    vert[ 30] = new PVector(  0.5,   C1,  -C3 );
    vert[ 31] = new PVector(  0.5,   C1,   C3 );
    vert[ 32] = new PVector( -0.5,  -C1,  -C3 );
    vert[ 33] = new PVector( -0.5,  -C1,   C3 );
    vert[ 34] = new PVector( -0.5,   C1,  -C3 );
    vert[ 35] = new PVector( -0.5,   C1,   C3 );
