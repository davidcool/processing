...
public class SnubDodecadodecahedron extends Polyhedron {
  ...
  final float C0  = 0.109916902433172651090492403707;   //square-root of a root of the polynomial:  65536*(x^8) - 114688*(x^7) + 90112*(x^6) - 48128*(x^5) + 11008*(x^4) + 2496*(x^3) - 592*(x^2) - 76*x + 1
  final float C1  = 0.201581385528028781981346763340;   //square-root of a root of the polynomial:  65536*(x^8) - 81920*(x^7) - 36864*(x^6) + 5120*(x^5) + 10496*(x^4) + 320*(x^3) - 144*(x^2) - 20*x + 1
  final float C2  = 0.2132629972423431530340912974046;  //square-root of a root of the polynomial:  256*(x^4) - 448*(x^3)+ 240*(x^2) - 32*x + 1
  final float C3  = 0.311498287961201433071839167047;   //square-root of a root of the polynomial:  65536*(x^8) - 65536*(x^7) - 16384*(x^6) + 26624*(x^5) + 3584*(x^4) - 4864*(x^3) + 928*(x^2) - 60*x + 1
  final float C4  = 0.391112281317322520035815656719;   //square-root of a root of the polynomial:  65536*(x^8) - 65536*(x^7) - 16384*(x^6) + 26624*(x^5) + 3584*(x^4) - 4864*(x^3) + 928*(x^2) - 60*x + 1
  final float C5  = 0.4549836805139589684034395850047;  //square-root of a root of the polynomial:  65536*(x^8) - 163840*(x^7) + 196608*(x^6) - 138240*(x^5) + 60928*(x^4) - 17280*(x^3) + 2928*(x^2) - 220*x + 1
  final float C6  = 0.522916062155765684314671540611;   //square-root of a root of the polynomial:  4096*(x^8) - 5120*(x^7) + 3072*(x^6) - 1920*(x^5) + 1248*(x^4) - 600*(x^3) + 177*(x^2) - 25*x + 1
  final float C7  = 0.656565066041987750384786348344;   //square-root of a root of the polynomial:  4096*(x^8) - 5120*(x^7) + 3072*(x^6) - 1920*(x^5) + 1248*(x^4) - 600*(x^3) + 177*(x^2) - 25*x + 1
  final float C8  = 0.717277814600969258425288142552;   //square-root of a root of the polynomial:  65536*(x^8) - 163840*(x^7) + 196608*(x^6) - 138240*(x^5) + 60928*(x^4) - 17280*(x^3) + 2928*(x^2) - 220*x + 1
  final float C9  = 0.834414350116967117386510707658;   //square-root of a root of the polynomial:  65536*(x^8) - 114688*(x^7) + 69632*(x^6) - 43008*(x^5) + 22528*(x^4) - 4544*(x^3) + 1888*(x^2) - 136*x + 1
  final float C10 = 0.849081595439412422704144026444;   //square-root of a root of the polynomial:  65536*(x^8) - 114688*(x^7) + 90112*(x^6) - 48128*(x^5) + 11008*(x^4) + 2496*(x^3) - 592*(x^2) - 76*x + 1
  final float C11 = 0.958998497872585073794636430152;   //square-root of a root of the polynomial:  64*(x^4) - 112*(x^3) + 64*(x^2) - 15*x + 1
  final float C12 = 1.04767734735931027042060200506;    //square-root of a root of the polynomial:  65536*(x^8) - 114688*(x^7) + 69632*(x^6) - 43008*(x^5) + 22528*(x^4) - 4544*(x^3) + 1888*(x^2) - 136*x + 1
  final float C13 = 1.17226149511492822682872772756;    //square-root of a root of the polynomial:  256*(x^4) - 512*(x^3) + 240*(x^2) - 28*x + 1
  final float C14 = 1.24019387675673494273995968316;    //square-root of a root of the polynomial:  65536*(x^8) - 81920*(x^7) - 36864*(x^6) + 5120*(x^5) + 10496*(x^4) + 320*(x^3) - 144*(x^2) - 20*x + 1
