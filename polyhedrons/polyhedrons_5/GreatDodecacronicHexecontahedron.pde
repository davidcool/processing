/*
GreatDodecacronicHexecontahedron class
...
public class GreatDodecacronicHexecontahedron extends Polyhedron {
  ...
  final float C4 = 0.4606553370833683839318043885448;  //(5 - sqrt(5)) / 6
  final float C5 = 0.580178728295464104708673924149;   //(15 - sqrt(5)) / 22
  final float C6 = 0.618033988749894848204586834366;   //(sqrt(5) - 1) / 2
  private PVector[] vert = new PVector[44]; // list of ve//rtices
  private int[][] faces =  new int[FACES][VERTICES];  // list of faces (joining vertices)
  
  private GreatDodecacronicHexecontahedron() {   
    // set vertices
    vert[  0] = new PVector( 0.0,  C6, -C3 );
    vert[  1] = new PVector( 0.0,  C6,  C3 );
    vert[  2] = new PVector( 0.0, -C6, -C3 );
    vert[  3] = new PVector( 0.0, -C6,  C3 );
    ...
    vert[ 10] = new PVector(  C3, 0.0,  C6 );
    vert[ 11] = new PVector(  C3, 0.0, -C6 );
  ...
  } //end GreatDodecacronicHexecontahedron()

  public String name() {
    return "Great Dodecacronic Hexecontahedron";
  }
...
} //end class GreatDodecacronicHexecontahedron
