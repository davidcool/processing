/*
GreatHexacronicIcositetrahedron class
...
public class GreatHexacronicIcositetrahedron extends Polyhedron {
  
  // polyhedron
  final int FACES = 24;     // number of faces 
  final int VERTICES = 4;   // VERTICES per face
  final float C0 = 0.369398062518129278742615896541;  //(4 - sqrt(2)) / 77
  final float C1 = 0.585786437626904951198311275790;  //2 - sqrt(2)
  final float C2 = 1.41421356237309504880168872421;   //sqrt(2)
  private PVector[] vert = new PVector[20]; // list of ve//rtices
  private int[][] faces =  new int[FACES][VERTICES];  // list of faces (joining vertices)
  
  private GreatHexacronicIcositetrahedron() {   
    // set vertices
    ...
    vert[  6] = new PVector( 0.0, 0.0,  C2 );
    vert[  7] = new PVector( 0.0, 0.0, -C2 );
    vert[  8] = new PVector(  C2, 0.0, 0.0 );
    vert[  9] = new PVector( -C2, 0.0, 0.0 );
    vert[ 10] = new PVector( 0.0,  C2, 0.0 );
    vert[ 11] = new PVector( 0.0, -C2, 0.0 );
  ...
  } //end GreatHexacronicIcositetrahedron()

  public String name() {
    return "Great Hexacronic Icositetrahedron";
  }
...
} //end class GreatHexacronicIcositetrahedron
