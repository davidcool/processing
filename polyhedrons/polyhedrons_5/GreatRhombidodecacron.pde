...
public class GreatRhombidodecacron extends Polyhedron {
  ...
  final float C5 = 2.23606797749978969640917366873;   //sqrt(5)
  private PVector[] vert = new PVector[42]; // list of ve//rtices
  private int[][] faces =  new int[FACES][VERTICES];  // list of faces (joining vertices)
  
  private GreatRhombidodecacron() {   
    // set vertices
    ...
    vert[ 14] = new PVector( 0.0, -C5, 0.0 );
    vert[ 15] = new PVector( 0.0,  C5, 0.0 );
    vert[ 16] = new PVector( -C5, 0.0, 0.0 );
    vert[ 17] = new PVector(  C5, 0.0, 0.0 );
    vert[ 18] = new PVector( -C3,  C4,  C2 );
    vert[ 19] = new PVector( -C3,  C4, -C2 );
    vert[ 20] = new PVector(  C3,  C4,  C2 );
    vert[ 21] = new PVector(  C3,  C4, -C2 );
    vert[ 22] = new PVector( -C3, -C4,  C2 );
    vert[ 23] = new PVector( -C3, -C4, -C2 );
    vert[ 24] = new PVector(  C3, -C4,  C2 );
    vert[ 25] = new PVector(  C3, -C4, -C2 );
    vert[ 26] = new PVector(  C4,  C2, -C3 );
    vert[ 27] = new PVector(  C4,  C2,  C3 );
    vert[ 28] = new PVector( -C4,  C2, -C3 );
    vert[ 29] = new PVector( -C4,  C2,  C3 );
    vert[ 30] = new PVector(  C4, -C2, -C3 );
    vert[ 31] = new PVector(  C4, -C2,  C3 );
    vert[ 32] = new PVector( -C4, -C2, -C3 );
    vert[ 33] = new PVector( -C4, -C2,  C3 );
    vert[ 34] = new PVector(  C2, -C3,  C4 );
    vert[ 35] = new PVector(  C2, -C3, -C4 );
    vert[ 36] = new PVector( -C2, -C3,  C4 );
    vert[ 37] = new PVector( -C2, -C3, -C4 );
    vert[ 38] = new PVector(  C2,  C3,  C4 );
    vert[ 39] = new PVector(  C2,  C3, -C4 );
    vert[ 40] = new PVector( -C2,  C3,  C4 );
    vert[ 41] = new PVector( -C2,  C3, -C4 );
    // set faces
  ...
  } //end GreatRhombidodecacron()

  public String name() {
    return "Great Rhombidodecacron";
  }
...
} //end class GreatRhombidodecacron
