...
public class GreatTriakisOctahedron extends Polyhedron {
  
  // polyhedron
  final int FACES = 24;     // number of faces 
  final int VERTICES = 3;   // VERTICES per face
  final float C0 = 0.414213562373095048801688724210;  //sqrt(2) - 1
  private PVector[] vert = new PVector[14]; // list of ve//rtices
  private int[][] faces =  new int[FACES][VERTICES];  // list of faces (joining vertices)
  
  private GreatTriakisOctahedron() {   
    // set vertices
  ...
  } //end GreatTriakisOctahedron()

  public String name() {
    return "Great Triakis Octahedron";
  }
...
} //end class GreatTriakisOctahedron
