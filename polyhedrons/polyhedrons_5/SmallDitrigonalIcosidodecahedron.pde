...
public class SmallDitrigonalIcosidodecahedron extends Polyhedron {
  ...
  private SmallDitrigonalIcosidodecahedron() {   
    // set vertices
    vert[  0] = new PVector(  -C1,  0.0,  -C0 );
    vert[  1] = new PVector(  -C1,  0.0,   C0 );
    vert[  2] = new PVector(   C1,  0.0,  -C0 );
    vert[  3] = new PVector(   C1,  0.0,   C0 );
    vert[  4] = new PVector(  0.0,  -C0,  -C1 );
    vert[  5] = new PVector(  0.0,  -C0,   C1 );
    vert[  6] = new PVector(  0.0,   C0,  -C1 );
    vert[  7] = new PVector(  0.0,   C0,   C1 );
