/*
SmallIcosacronicHexecontahedron class
...
public class SmallIcosacronicHexecontahedron extends Polyhedron {
  ...
  final float C2 = 0.870268092443196157063010886223;  //3 * (15 - sqrt(5)) / 44
  final float C3 = 0.966005366644720239190197921216;  //3 * (10 + sqrt(5)) / 38
  final float C4 = 1.11803398874989484820458683437;   //sqrt(5) / 2
  final float C5 = 1.40812335289762690055892379644;   //3 * (5 + 7 * sqrt(5)) / 44
  final float C6 = 1.56302951654596131554608856669;   //3 * (15 + 11 * sqrt(5)) / 76
  ...
  private SmallIcosacronicHexecontahedron() {   
    // set vertices
    vert[  0] = new PVector(  C7, 0.0,  C1 );
    vert[  1] = new PVector(  C7, 0.0, -C1 );
    vert[  2] = new PVector( -C7, 0.0,  C1 );
    vert[  3] = new PVector( -C7, 0.0, -C1 );
    vert[  4] = new PVector( 0.0,  C1,  C7 );
    vert[  5] = new PVector( 0.0,  C1, -C7 );
    vert[  6] = new PVector( 0.0, -C1,  C7 );
    vert[  7] = new PVector( 0.0, -C1, -C7 );
    vert[  8] = new PVector(  C1,  C7, 0.0 );
    vert[  9] = new PVector( -C1,  C7, 0.0 );
    vert[ 10] = new PVector(  C1, -C7, 0.0 );
    vert[ 11] = new PVector( -C1, -C7, 0.0 );
    vert[ 12] = new PVector( 0.0, -C5,  C2 );
    vert[ 13] = new PVector( 0.0, -C5, -C2 );
    vert[ 14] = new PVector( 0.0,  C5,  C2 );
    vert[ 15] = new PVector( 0.0,  C5, -C2 );
    vert[ 16] = new PVector( -C5,  C2, 0.0 );
    vert[ 17] = new PVector(  C5,  C2, 0.0 );
    vert[ 18] = new PVector( -C5, -C2, 0.0 );
    vert[ 19] = new PVector(  C5, -C2, 0.0 );
    vert[ 20] = new PVector(  C2, 0.0, -C5 );
    vert[ 21] = new PVector(  C2, 0.0,  C5 );
    vert[ 22] = new PVector( -C2, 0.0, -C5 );
    vert[ 23] = new PVector( -C2, 0.0,  C5 );
    vert[ 24] = new PVector( -C4, -C4, -C4 );
    vert[ 25] = new PVector( -C4, -C4,  C4 );
    vert[ 26] = new PVector(  C4, -C4, -C4 );
    vert[ 27] = new PVector(  C4, -C4,  C4 );
    vert[ 28] = new PVector( -C4,  C4, -C4 );
    vert[ 29] = new PVector( -C4,  C4,  C4 );
    vert[ 30] = new PVector(  C4,  C4, -C4 );
    vert[ 31] = new PVector(  C4,  C4,  C4 );
    vert[ 32] = new PVector( -C6, 0.0, -C0 );
    vert[ 33] = new PVector( -C6, 0.0,  C0 );
    vert[ 34] = new PVector(  C6, 0.0, -C0 );
    vert[ 35] = new PVector(  C6, 0.0,  C0 );
    vert[ 36] = new PVector( 0.0, -C0, -C6 );
    vert[ 37] = new PVector( 0.0, -C0,  C6 );
    vert[ 38] = new PVector( 0.0,  C0, -C6 );
    vert[ 39] = new PVector( 0.0,  C0,  C6 );
    vert[ 40] = new PVector( -C0, -C6, 0.0 );
    vert[ 41] = new PVector(  C0, -C6, 0.0 );
    vert[ 42] = new PVector( -C0,  C6, 0.0 );
    vert[ 43] = new PVector(  C0,  C6, 0.0 );
    vert[ 44] = new PVector(  C3,  C3,  C3 );
    vert[ 45] = new PVector(  C3,  C3, -C3 );
    vert[ 46] = new PVector( -C3,  C3,  C3 );
    vert[ 47] = new PVector( -C3,  C3, -C3 );
    vert[ 48] = new PVector(  C3, -C3,  C3 );
    vert[ 49] = new PVector(  C3, -C3, -C3 );
    vert[ 50] = new PVector( -C3, -C3,  C3 );
    vert[ 51] = new PVector( -C3, -C3, -C3 );
    // set faces
  ...
  } //end SmallIcosacronicHexecontahedron()

  public String name() {
    return "Small Icosacronic Hexecontahedron";
  }
...
} //end class SmallIcosacronicHexecontahedron
