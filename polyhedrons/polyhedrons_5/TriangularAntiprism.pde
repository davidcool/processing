...
public class TriangularAntiprism extends Polyhedron {
  ...
  } //end TriangularAntiprism()

  public String name() {
    return "Triangular Antiprism (Octahedron)";
  }
